...
- **databases/** - Database configurations (CockroachDB, CouchDB cluster, PostgreSQL)
...
| **Valkey** | Redis community fork | [valkey-io/valkey](https://github.com/valkey-io/valkey) |
...
| **SurrealDB** | Multi-model database | [surrealdb/surrealdb](https://github.com/surrealdb/surrealdb) |
| **Cassandra** | Distributed NoSQL database | [apache/cassandra](https://github.com/apache/cassandra) |
| **ScyllaDB** | High-performance Cassandra | [scylladb/scylladb](https://github.com/scylladb/scylladb) |
| **Meilisearch** | Lightning-fast search | [meilisearch/meilisearch](https://github.com/meilisearch/meilisearch) |
| **Typesense** | Fast search engine | [typesense/typesense](https://github.com/typesense/typesense) |
