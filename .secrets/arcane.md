...
```yaml
arcane_admin_email: "{{ lookup('file', '/Volumes/X9 Pro/Workspaces/nkaurelien/docker-examples/.secrets/arcane-admin-email', errors='ignore') | default('.secrets/admin-login', true) | trim }}"
```
